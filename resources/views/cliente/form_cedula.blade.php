<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-row">
            ...
            <label for="id_nacionalidad" class="form-label">{{ __('Nacionalidad') }}</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
            <label for="id_nacionalidad" class="form-label">{{ __('Beneficiario Nacionalidad') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="b_cedula" class="form-label">{{ __('Beneficiario Cedula') }}</label>
            <input type="text" name="b_cedula" class="form-control @error('b_cedula') is-invalid @enderror" value="{{ old('b_cedula', $cliente?->b_cedula) }}" id="b_cedula" placeholder="Beneficiario Cedula">
            {!! $errors->first('b_cedula', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>


        <div class="form-group mb-2 mb20">
            <label for="b_nombre" class="form-label">{{ __('Beneficiario Nombre') }}</label>
            <input type="text" name="b_nombre" class="form-control @error('b_nombre') is-invalid @enderror" value="{{ old('b_nombre', $cliente?->b_nombre) }}" id="b_nombre" placeholder="Beneficiario Nombre">
            {!! $errors->first('b_nombre', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="b_apellido" class="form-label">{{ __('Beneficiario Apellido') }}</label>
            <input type="text" name="b_apellido" class="form-control @error('b_apellido') is-invalid @enderror" value="{{ old('b_apellido', $cliente?->b_apellido) }}" id="b_apellido" placeholder="Beneficiario Apellido">
